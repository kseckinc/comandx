    ...
    <div class="step-container">
            ...
            <el-row>
              ...
              <el-col :span="19">
                <el-radio-group v-model="form.mount.mount_type">
                  <el-radio-button label="Nginx" name="Nginx"></el-radio-button>
                  <el-radio-button label="SLB" name="SLB"></el-radio-button>
                  <el-radio-button label="ELB" name="ELB"></el-radio-button>
                </el-radio-group>
              </el-col>
            </el-row>
          </div>
      ...
      <div class="buttons">
        ...
        <el-button
          ...
          >下一步</el-button
        >
        <el-button style="margin-top: 12px" size="medium" @click="submit"
          >完成</el-button
        >
        <el-button
          style="margin-top: 12px"
